...
<section class="section section-md bg-default" id="our-tips">
          <div class="container">
            ...
            {*get first three blogs in smarty template*}
            {foreach from=$blogs.firstSection item=blog }
              <div class="col-xl-3 col-lg-4 col-sm-6">
                <article class="post-corporate">
                  <figure class="post-corporate-figure"><a class="link-img" href="index.php?p=article&id={$blog.blog_id}"><img src="{$blog.image_url}" alt="" width="280" height="280"></a></figure>
                  <h4 class="post-corporate-title"><a href="index.php?p=article&id={$blog.blog_id}">{$blog.title}</a></h4>
                </article>
              </div>
            {/foreach}
            </div>
...
<div class="container">
  <div class="row row-40 align-items-center wow fadeInUp">
    <div class="col-xl-7 col-lg-6">
      <div class="img-video">
      <a href="index.php?p=article&id={$blogs.secondSection[0].blog_id}"><img class="box-shadow" src="{$blogs.secondSection[0].image_url}" alt="" width="660" height="406"/></a>
      </div>
    </div>
    <div class="col-xl-5 col-lg-6">
    <h6>Blog</h6>
      <h2>{$blogs.secondSection[0].title}</h2>
    </div>
  </div>
</div>
</section>
